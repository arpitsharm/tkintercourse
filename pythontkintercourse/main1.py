...
f2 = ttk.Entry(window, textvariable=var1)
...
f3 = ttk.Entry(window, textvariable=var2)
...
f4 = ttk.Combobox(window, textvariable=var3, value=values, state="readonly")
...
f5 = ttk.Entry(window, textvariable=var4)
f5.place(x=180, y=305)

lbl6 = ttk.Label(master = window, text = "Your Amout : ", background="black", foreground="white", font=("times new roman", 14))
...
btn1 = ttk.Button(window, text="Genrate Slip", cursor="hand2", command=genrate)
